package com.thesis.fixitadmin.shareChat;
...
import com.thesis.fixitadmin.adapter.AdapterChat;
import com.thesis.fixitadmin.MainActivity;
import com.thesis.fixitadmin.model.ModelChat;
import com.thesis.fixitadmin.model.ModelUser;
import com.thesis.fixitadmin.R;
import com.thesis.fixitadmin.SharedPref;
import com.thesis.fixitadmin.notifications.Data;
import com.thesis.fixitadmin.notifications.Sender;
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot ds: snapshot.getChildren()){
                    ...
                    Data data = new Data(myUid, name + " : " + message, "New Message", hisId, R.drawable.logov3);
                    ...
                    try {
                        ...
                        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest("https://fcm.googleapis.com/fcm/send", jsonObject, new Response.Listener<JSONObject>() {
                            ...
                            public Map<String, String> getHeaders() throws AuthFailureError {
                                ...
                                headers.put("Authorization", "key=AAAAgNPedg8:AAAAOoc8VaE:APA91bG4mhdXbN3_qKswzvgbHS_-hk2aRhQrKQtR4-lLah5cL_pz_K6s8EHWSuHCpz8OGCE1hvwf2JEZu0N7aCEx7XQaCiRRbU63jetNlOyLEBJLRksEYIymLT21refoghs-vqq_Cz_x");
                                return headers;
                            }
                        };
