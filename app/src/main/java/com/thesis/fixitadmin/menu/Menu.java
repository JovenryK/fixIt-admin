package com.thesis.fixitadmin.menu;
...
import com.thesis.fixitadmin.user.MyFollowing;
import com.thesis.fixitadmin.welcome.IntroLast;
...
public class Menu extends AppCompatActivity {
    ...
    ConstraintLayout logout,save,followers,following,invite,policy,delete,email,password,analytics;
    Switch aSwitch;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       sharedPref = new SharedPref(this);
        ...
        invite.setOnClickListener(v -> {
            String shareBody = "FixIt - FixIt App" + " Download now Drive lang muna 😁😁 \nhttps://drive.google.com/drive/u/0/folders/1DZncBGirFSkK6LGL1bg6tNZLLhOIht66";
        ...
        analytics.setOnClickListener(v -> {
            Intent intent = new Intent(Menu.this, activity_analytics.class);
            startActivity(intent);
        });
