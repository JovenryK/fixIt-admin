...
public class EmergencyActivity extends AppCompatActivity {
    ...
    String[] legendName = {"Emergency", "Dog", "Cat", "Rat"};
    ...
    //Day Data
    int EcountMon, EcountTue, EcountWed, EcountThu, EcountFri, EcountSat, EcountSun = 0;

    //Week data
    int Ecount1, Ecount2, Ecount3, Ecount4, Ecount5, Ecount6, Ecount7 = 0;
    int Ecount8, Ecount9, Ecount10, Ecount11, Ecount12, Ecount13, Ecount14 = 0;
    int Ecount15, Ecount16, Ecount17, Ecount18, Ecount19, Ecount20, Ecount21 = 0;
    int Ecount22, Ecount23, Ecount24, Ecount25, Ecount26, Ecount27, Ecount28, Ecount29, Ecount30, Ecount31 = 0;
        ...
        ValueEventListener valueEventListener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot ds : snapshot.getChildren()) {
                    ...
                    if (ds.child("type").getValue(String.class).equals("Electrical Emergency")) {
                        if (splitsdate[1].equals("Jan")) {
                            ELjancountEm += 1;
                        }
                    }
                ...
                lineChart = findViewById(R.id.lineChartE);
...
//        yAxisLeft.setValueFormatter(new MyAxisValueFormatter());
                ...
                data.setValueFormatter(new EmergencyActivity.MyValueFormatter());
        ...
        ValueEventListener valueEventListener1 = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot ds : snapshot.getChildren()) {
                    ...
                    d = new Date(Long.valueOf(pTime));
                    splitsdate = d.toString().split(" ");
                    int data = EcountMon + EcountTue+ EcountWed + EcountThu+ EcountFri+ EcountSat+ EcountSun;
//
...
//                    text.setText(String.valueOf(EcountSat));
                ...
                lineChart1 = findViewById(R.id.lineChartE2);
...
//        yAxisLeft.setValueFormatter(new MyAxisValueFormatter());
                ...
                data1.setValueFormatter(new EmergencyActivity.MyValueFormatter());
        ...
        ValueEventListener valueEventListener2 = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                lineChart1 = findViewById(R.id.lineChartE3);
...
//
        ...
        //5
        barFour.add(new Entry(0, (valOne[0] / sumpost[3]) * 100));
        barFour.add(new Entry(1, (valOne[1] / sumpost[3]) * 100));
        barFour.add(new Entry(2, (valOne[2] / sumpost[3]) * 100));
        barFour.add(new Entry(3, (valOne[3] / sumpost[3]) * 100));
        barFour.add(new Entry(4, (valOne[4] / sumpost[3]) * 100));
        barFour.add(new Entry(5, (valOne[5] / sumpost[3]) * 100));
...
//Weekly
    private ArrayList<Entry> dataValues2(){
        ...
        int[] valFour = {HjancountEm, HfebcountEm, HmarcountEm, HaprcountEm, HmaycountEm, HjuncountEm, HjulcountEm, HaugcountEm, HsepcountEm, HoctcountEm, HnovcountEm, HdeccountEm};
        int[] valFive = {RjancountEm, RfebcountEm, RmarcountEm, RaprcountEm, RmaycountEm, RjuncountEm, RjulcountEm, RaugcountEm, RsepcountEm, RoctcountEm, RnovcountEm, RdeccountEm};
        int data = Ecount1 + Ecount2 + Ecount3 + Ecount4 + Ecount5 + Ecount6 + Ecount7;
        int data2 = Ecount8 + Ecount9 + Ecount10 + Ecount11 + Ecount12 + Ecount13 + Ecount14;
        int data3 = Ecount15 + Ecount16 + Ecount17 + Ecount18 + Ecount19 + Ecount20 + Ecount21;
        int data4 = Ecount22 + Ecount23 + Ecount24 + Ecount25 + Ecount26 + Ecount27 + Ecount28 + Ecount29 + Ecount30 + Ecount31;
...
//Daily
    private ArrayList<Entry> dataValues3(){
        ...
        int[] Daily = {EcountMon, EcountTue, EcountWed, EcountThu, EcountFri, EcountSat, EcountSun};
