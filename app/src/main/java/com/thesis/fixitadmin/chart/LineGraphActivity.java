...
//        yAxisLeft.setValueFormatter(new MyAxisValueFormatter());
                ...
                data.setValueFormatter(new LineGraphActivity.MyValueFormatter());
...
//        yAxisLeft.setValueFormatter(new MyAxisValueFormatter());
                ...
                description1.setText("Electric Complaints");
                ...
                data1.setValueFormatter(new LineGraphActivity.MyValueFormatter());
