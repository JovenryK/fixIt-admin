...
//        yAxisLeft.setValueFormatter(new MyAxisValueFormatter());
                ...
                data.setValueFormatter(new LineChart3Activity.MyValueFormatter());
...
//
        ...
        //5
        barFour.add(new Entry(0, (valFive[0] / sumpost[3]) * 100));
        barFour.add(new Entry(1, (valFive[1] / sumpost[3]) * 100));
        barFour.add(new Entry(2, (valFive[2] / sumpost[3]) * 100));
        barFour.add(new Entry(3, (valFive[3] / sumpost[3]) * 100));
        barFour.add(new Entry(4, (valFive[4] / sumpost[3]) * 100));
        barFour.add(new Entry(5, (valFive[5] / sumpost[3]) * 100));
