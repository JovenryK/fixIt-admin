...
import com.thesis.fixitadmin.adapter.AdapterComments;
import com.thesis.fixitadmin.groups.ShareGroupActivity;
import com.thesis.fixitadmin.model.ModelComments;
...
import com.thesis.fixitadmin.SharedPref;
...
public class PostDetails extends AppCompatActivity implements View.OnClickListener {
    ...
    TextView name,type,text,likeNo,commentNo,views, stattext;
//    EditText textBox;
    ConstraintLayout constraintLayout9,viewlt;
    private String userId, myName, myDp;
    private DatabaseReference mDatabase;
    String hisId, hisName, postId, pLikes, hisDp, hisMeme, hisVine, hisTime, hisText, hisTypes,currentStatus  ;
    ...
    private void likePost() {
        ...
        likeRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (mProcessCLike) {
                    if (dataSnapshot.child(postId).hasChild(userId)) {
                        likeRef.child(postId).child("status").setValue("Pending");
                        mProcessCLike = false;
                    }
                }
            }
...
//    }
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds : dataSnapshot.getChildren()){
                    ...
                    currentStatus =  ""+ds.child("status").getValue();
                    ...
                    stattext.setText(currentStatus);
                    //DP
                    try {
    ...
    private Uri saveImageToShare(Bitmap bitmap) {
        ...
        try {
            ...
            stream.flush();
            stream.close();
            uri = FileProvider.getUriForFile(this, "com.thesis.fixitadmin.fileprovider", file);
