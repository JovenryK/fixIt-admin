...
public class Post extends AppCompatActivity {
    ...
    RelativeLayout pending_layout, ongoing_layout, done_layout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pending_layout = findViewById(R.id.relativeLayout);
        ongoing_layout = findViewById(R.id.relativeLayout6);
        done_layout = findViewById(R.id.relativeLayout2);
