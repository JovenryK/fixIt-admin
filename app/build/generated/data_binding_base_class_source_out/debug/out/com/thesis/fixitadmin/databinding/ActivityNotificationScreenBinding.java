...
public final class ActivityNotificationScreenBinding implements ViewBinding {
  ...
  private ActivityNotificationScreenBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ActivityNotificationScreenBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  @NonNull
  public static ActivityNotificationScreenBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityNotificationScreenBinding((ConstraintLayout) rootView, header, imageView3,
