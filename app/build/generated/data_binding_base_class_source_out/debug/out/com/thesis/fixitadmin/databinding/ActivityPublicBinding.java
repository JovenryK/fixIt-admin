...
public final class ActivityPublicBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final LineChart lineChartP;

  @NonNull
  public final LineChart lineChartP1;

  @NonNull
  public final LineChart lineChartP2;
  ...
  private ActivityPublicBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull ImageView backtoA, @NonNull RelativeLayout header, @NonNull LineChart lineChartP,
      @NonNull LineChart lineChartP1, @NonNull LineChart lineChartP2, @NonNull Button print,
    ...
    this.header = header;
    this.lineChartP = lineChartP;
    this.lineChartP1 = lineChartP1;
    this.lineChartP2 = lineChartP2;
    this.print = print;
  ...
  @NonNull
  public static ActivityPublicBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityPublicBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_public, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityPublicBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.lineChartP;
      LineChart lineChartP = ViewBindings.findChildViewById(rootView, id);
      if (lineChartP == null) {
        break missingId;
      }

      id = R.id.lineChartP1;
      LineChart lineChartP1 = ViewBindings.findChildViewById(rootView, id);
      if (lineChartP1 == null) {
        break missingId;
      }

      id = R.id.lineChartP2;
      LineChart lineChartP2 = ViewBindings.findChildViewById(rootView, id);
      if (lineChartP2 == null) {
        break missingId;
      }
      ...
      return new ActivityPublicBinding((ConstraintLayout) rootView, EmergencyLayoutEl,
          EmergencyLayoutEl2, EmergencyLayoutEl3, EmergencyTv1, backtoA, header, lineChartP,
          lineChartP1, lineChartP2, print, textView);
    }
