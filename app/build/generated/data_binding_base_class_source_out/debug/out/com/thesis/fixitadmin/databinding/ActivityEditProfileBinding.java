...
public final class ActivityEditProfileBinding implements ViewBinding {
  ...
  private ActivityEditProfileBinding(@NonNull RelativeLayout rootView, @NonNull AdView adView,
      ...
      @NonNull TextView name, @NonNull ImageView nameImg, @NonNull RelativeLayout nameLayout,
      @NonNull ProgressBar pb, @NonNull CircleImageView profileImage,
      @NonNull RelativeLayout profileLayout, @NonNull RelativeLayout relativeLayout,
      @NonNull TextView textView11, @NonNull TextView textView9, @NonNull ImageView usernameImg,
  ...
  public static ActivityEditProfileBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityEditProfileBinding((RelativeLayout) rootView, adView, bio, bioImg,
          bioLayout, edit, header, imageView3, imageView4, link, location, locationImg,
          locationLayout, name, nameImg, nameLayout, pb, profileImage, profileLayout,
          relativeLayout, textView11, textView9, usernameImg, usernameLayout, webImg, webLayout);
    }
